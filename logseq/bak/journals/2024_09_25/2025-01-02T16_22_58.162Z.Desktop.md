...
Yesterday:: [[Pal_2024_09_24_Tue]] 
Tomorrow:: [[Pal_2024_09_26_Thu]]  
Week:: [[Pal_2024_W39_Q3]]  
Month:: [[Pal_2024_09]]  
Year::  [[Pal_2024]]  
Last year::  [[Pal_2023_09_25_Mon]] 
Quote::  
...
Health aggregator --> Health provider 
- Share the database and have quorum agreement to reach consensus 
- Two phase locking to confirm the transaction 
- Keep trying the nearest appointment 
- Redirect directly to the health provider website 
- Have reads from your database and writes from the health provider 
...
from #medium
where file.mday = date(2024-09-25)
sort file.name asc
```
